      ...
      <Toolbar>
        <Container maxWidth={"lg"} sx={containerSx}>
          ...
          <div>
            ...
            <NavLink style={{color: 'white', marginRight: '20px'}} to={Path.Main} >Main</NavLink>
            <NavLink style={{color: 'white'}} to={Path.Faq} >Faq</NavLink>
            {/*<NavButton to={Path.Faq} background={theme.palette.primary.dark}>Faq</NavButton>*/}
